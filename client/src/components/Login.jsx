...
const Login = () => {
  ...
  return (
    <div className=":alert/bg-orange-400 flex items-center justify-center h-screen w-screen box-border">
      <div className="flex flex-col items-center">
        <img className="w-20 h-20 object-contain" src="https://i.ibb.co/7vvs1rq/Coder-PNG-File-533x420.png"/>
        <span className="italic text-xl font-bold m-2 text-white shadow-md">Kysymys</span>
